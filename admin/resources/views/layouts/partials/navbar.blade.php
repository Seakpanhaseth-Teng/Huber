<nav class="bg-brand-navy text-white">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex items-center justify-between h-16">
            ...
            <div class="navbar-collapse hidden lg:flex lg:items-center lg:gap-2">
                <ul class="flex flex-col lg:flex-row lg:items-center lg:gap-1 list-none ml-auto mb-0">
                    @auth
                        ...
                        <li class="relative">
                            ...
                            <ul class="dropdown-menu absolute right-0 mt-1 bg-white rounded-xl shadow-lg border border-gray-200 min-w-[200px] hidden z-50 overflow-hidden">
                                <li>
