...
@section('title', 'Join Huber - Driver Registration')
...
<div class="min-h-screen bg-brand-warm flex items-center justify-center py-12 px-4">
    <div class="bg-white rounded-2xl shadow-sm border border-brand-border p-8 w-full max-w-md mx-auto">
        ...
        <form id="registerDriverForm">
            <h3 class="text-lg font-semibold text-brand-navy mb-2">Personal Information</h3>
            ...
            <div class="mb-6 p-4 border border-brand-border rounded-xl bg-brand-warm">
                <div class="flex items-center mb-2 gap-2">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 text-brand-amber" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 13l2-2m0 0l7-7 7 7M13 5v6h6" /></svg>
                    <span class="font-semibold text-brand-navy">Driver Information</span>
                </div>
                <div class="grid grid-cols-2 gap-3 mb-2">
                    <input type="text" id="license_number" name="license_number" placeholder="License Number" class="w-full px-4 py-3 border border-brand-border rounded-brand text-brand-navy placeholder:text-brand-navy/40 focus:border-brand-amber focus:ring-2 focus:ring-brand-amber/20 outline-none transition" required>
                    <input type="date" id="license_expiry" name="license_expiry" class="w-full px-4 py-3 border border-brand-border rounded-brand text-brand-navy focus:border-brand-amber focus:ring-2 focus:ring-brand-amber/20 outline-none transition" required>
                </div>
                <div class="mb-2">
                    <input type="text" id="vehicle_model" name="vehicle_model" placeholder="Vehicle Model (e.g. Camry)" class="w-full px-4 py-3 border border-brand-border rounded-brand text-brand-navy placeholder:text-brand-navy/40 focus:border-brand-amber focus:ring-2 focus:ring-brand-amber/20 outline-none transition" required>
                </div>
                <div class="grid grid-cols-2 gap-3 mb-2">
                    <input type="number" id="vehicle_year" name="vehicle_year" placeholder="Vehicle Year" class="w-full px-4 py-3 border border-brand-border rounded-brand text-brand-navy placeholder:text-brand-navy/40 focus:border-brand-amber focus:ring-2 focus:ring-brand-amber/20 outline-none transition" required>
                    <input type="text" id="vehicle_color" name="vehicle_color" placeholder="Vehicle Color" class="w-full px-4 py-3 border border-brand-border rounded-brand text-brand-navy placeholder:text-brand-navy/40 focus:border-brand-amber focus:ring-2 focus:ring-brand-amber/20 outline-none transition" required>
                </div>
                <div class="grid grid-cols-2 gap-3">
                    <input type="text" id="license_plate" name="license_plate" placeholder="License Plate" class="w-full px-4 py-3 border border-brand-border rounded-brand text-brand-navy placeholder:text-brand-navy/40 focus:border-brand-amber focus:ring-2 focus:ring-brand-amber/20 outline-none transition" required>
                    <input type="number" id="vehicle_seats" name="vehicle_seats" placeholder="Number of Seats" class="w-full px-4 py-3 border border-brand-border rounded-brand text-brand-navy placeholder:text-brand-navy/40 focus:border-brand-amber focus:ring-2 focus:ring-brand-amber/20 outline-none transition" required min="1" max="20">
                </div>
            </div>
            ...
            <div class="mb-6 p-4 border border-brand-border rounded-xl bg-brand-warm">
                <div class="flex items-center mb-3 gap-2">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 text-brand-amber" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 16l4.586-4.586a2 2 0 012.828 0L16 16m-2-2l1.586-1.586a2 2 0 012.828 0L20 14m-6-6h.01M6 20h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z" /></svg>
                    <span class="font-semibold text-brand-navy">Vehicle Photos</span>
                </div>
                <div class="mb-3">
                    <label class="block text-sm font-medium text-brand-navy/80 mb-1">Front View</label>
                    <input type="file" id="vehicle_photo_1" name="vehicle_photo_1" accept="image/*" class="w-full px-4 py-3 border border-brand-border rounded-brand text-brand-navy file:mr-4 file:py-2 file:px-4 file:rounded-brand file:border-0 file:text-sm file:font-semibold file:bg-brand-amber file:text-white hover:file:bg-brand-amber-600 transition" required>
                </div>
                <div class="mb-3">
                    <label class="block text-sm font-medium text-brand-navy/80 mb-1">Side View</label>
                    <input type="file" id="vehicle_photo_2" name="vehicle_photo_2" accept="image/*" class="w-full px-4 py-3 border border-brand-border rounded-brand text-brand-navy file:mr-4 file:py-2 file:px-4 file:rounded-brand file:border-0 file:text-sm file:font-semibold file:bg-brand-amber file:text-white hover:file:bg-brand-amber-600 transition" required>
                </div>
                <div class="mb-3">
                    <label class="block text-sm font-medium text-brand-navy/80 mb-1">Rear View</label>
                    <input type="file" id="vehicle_photo_3" name="vehicle_photo_3" accept="image/*" class="w-full px-4 py-3 border border-brand-border rounded-brand text-brand-navy file:mr-4 file:py-2 file:px-4 file:rounded-brand file:border-0 file:text-sm file:font-semibold file:bg-brand-amber file:text-white hover:file:bg-brand-amber-600 transition" required>
                </div>
            </div>
            ...
            <div id="registerDriverError" class="bg-red-50 text-red-700 p-3 rounded-lg mb-4 mt-2 hidden"></div>
        </form>
